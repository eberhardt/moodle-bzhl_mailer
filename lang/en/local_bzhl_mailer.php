...
$string["emailonenrolment"] = 'Email on enrolment';
$string["emailonenrolment_info"] = 'Sends an email notification to the list, when a user enrolled in one of the specified courses.';
